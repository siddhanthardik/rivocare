...
import { ArrowRight, CheckCircle2, Stethoscope, BriefcaseMedical, ClipboardList } from 'lucide-react';

const offerings = [
  'General Physician Consultations',
  'Post-Hospitalization Checkups',
    ...
    <div className="bg-slate-50 min-h-screen">
        ...
        <div className="relative mx-auto max-w-6xl px-6 text-center">
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }}>
            <span className="inline-flex items-center gap-2 rounded-full border border-blue-500/30 bg-blue-500/10 px-4 py-1.5 text-xs font-semibold tracking-widest text-blue-400 uppercase mb-6">
              <Stethoscope size={14} /> Medical Expertise
            </span>
            <h1 className="max-w-4xl mx-auto text-5xl font-black tracking-tight text-white sm:text-6xl">
              Consult a <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-emerald-400">Doctor</span> at Home.
            </h1>
            <p className="mt-8 max-w-2xl mx-auto text-lg leading-relaxed text-slate-300">
              Skip the waiting room. Have a licensed, experienced physician visit your home to diagnose, prescribe, and manage your health with undivided attention.
            </p>
            <div className="mt-10 flex justify-center">
              <Link to="/register" className="inline-flex h-14 items-center justify-center gap-2 rounded-2xl bg-blue-600 px-8 text-base font-bold text-white transition hover:bg-blue-700 shadow-xl shadow-blue-600/20 hover:-translate-y-0.5">
                Request a Visit <ArrowRight size={18} />
              </Link>
            </div>
          </motion.div>
        </div>
      ...
      <section className="mx-auto max-w-6xl px-6 py-24">
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          <div>
            <h2 className="text-3xl font-black text-slate-900 mb-6">Clinical diagnosis, without the commute.</h2>
            <p className="text-slate-600 text-lg leading-relaxed mb-8">
              Whether you're managing a chronic illness, feeling too unwell to travel, or seeking comprehensive preventive care for an elderly family member, our doctors provide thorough, unhurried consultations.
            </p>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
            <div className="bg-blue-50 rounded-3xl p-8 border border-blue-100">
              ...
              <h3 className="text-xl font-bold text-slate-900 mb-3">Thorough Exams</h3>
              <p className="text-slate-600 leading-relaxed">Unlike rushed clinic visits, home visits allow doctors to assess your actual living environment and spend quality time.</p>
            </div>
            <div className="bg-emerald-50 rounded-3xl p-8 border border-emerald-100 sm:translate-y-8">
              ...
              <h3 className="text-xl font-bold text-slate-900 mb-3">Clear Prescriptions</h3>
              <p className="text-slate-600 leading-relaxed">Receive instant digital prescriptions and actionable health advice directly to your RIVO dashboard.</p>
            </div>
          </div>
        </div>
      </section>
